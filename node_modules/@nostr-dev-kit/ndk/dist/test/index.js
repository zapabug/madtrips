...
var NDKUser = class _NDKUser {
  ...
  get nprofile() {
    ...
    return import_nostr_tools7.nip19.nprofileEncode({
      pubkey: this.pubkey,
      relays
    });
  }
...
var NDKPrivateKeySigner = class _NDKPrivateKeySigner {
    ...
    if (privateKey) {
      if (typeof privateKey === "string") {
        if (privateKey.startsWith("nsec1")) {
          ...
          this._privateKey = (0, import_utils6.hexToBytes)(privateKey);
        } else {
  ...
  get privateKey() {
    ...
    return (0, import_utils6.bytesToHex)(this._privateKey);
  }
  static generate() {
  ...
  async encrypt(recipient, value, scheme) {
    ...
    if (scheme == "nip44") {
      let conversationKey = import_nostr_tools8.nip44.v2.utils.getConversationKey(this._privateKey, recipientHexPubKey);
      return await import_nostr_tools8.nip44.v2.encrypt(value, conversationKey);
    }
  ...
  async decrypt(sender, value, scheme) {
    ...
    if (scheme == "nip44") {
      let conversationKey = import_nostr_tools8.nip44.v2.utils.getConversationKey(this._privateKey, senderHexPubKey);
      return await import_nostr_tools8.nip44.v2.decrypt(value, conversationKey);
    }
