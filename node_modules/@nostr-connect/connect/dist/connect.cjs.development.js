...
var NostrRPC = /*#__PURE__*/function () {
  function NostrRPC(opts) {
    ...
    this.self = {
      pubkey: nostrTools.getPublicKey(opts.secretKey),
                          ...
                          return _regeneratorRuntime().wrap(function _callee$(_context) {
                            while (1) switch (_context.prev = _context.next) {
                              case 0:
                                _context.prev = 0;
                                _context.next = 3;
                                return nostrTools.nip04.decrypt(_this.self.secret, event.pubkey, event.content);
                              case 3:
                ...
                return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                  while (1) switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.prev = 0;
                      _context4.next = 3;
                      return nostrTools.nip04.decrypt(_this2.self.secret, event.pubkey, event.content);
                    case 3:
  ...
  _prepareEvent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(secretKey, pubkey, content) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return nostrTools.nip04.encrypt(secretKey, pubkey, content);
        case 2:
          ...
          sig = nostrTools.signEvent(event, secretKey);
          signedEvent = _extends({}, event, {
            id: id,
            sig: sig
          });
          ok = nostrTools.validateEvent(signedEvent);
          veryOk = nostrTools.verifySignature(signedEvent);
          if (!(!ok || !veryOk)) {
            _context7.next = 11;
            break;
          }
  ...
  _connectToRelay = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(realayURL) {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          relay = nostrTools.relayInit(realayURL);
          _context8.next = 3;
...
})(exports.TimeRanges || (exports.TimeRanges = {}));
var TimeRangeToUnix = (_TimeRangeToUnix = {}, _TimeRangeToUnix[exports.TimeRanges.FIVE_MINS] = /*#__PURE__*/Math.round( /*#__PURE__*/Date.now() / 1000) + 60 * 5, _TimeRangeToUnix[exports.TimeRanges.ONE_HR] = /*#__PURE__*/Math.round( /*#__PURE__*/Date.now() / 1000) + 60 * 60, _TimeRangeToUnix[exports.TimeRanges.ONE_DAY] = /*#__PURE__*/Math.round( /*#__PURE__*/Date.now() / 1000) + 60 * 60 * 24, _TimeRangeToUnix[exports.TimeRanges.ONE_WEEK] = /*#__PURE__*/Math.round( /*#__PURE__*/Date.now() / 1000) + 60 * 60 * 24 * 7, _TimeRangeToUnix[exports.TimeRanges.ONE_MONTH] = /*#__PURE__*/Math.round( /*#__PURE__*/Date.now() / 1000) + 60 * 60 * 24 * 30, _TimeRangeToUnix[exports.TimeRanges.ONE_YEAR] = /*#__PURE__*/Math.round( /*#__PURE__*/Date.now() / 1000) + 60 * 60 * 24 * 365, _TimeRangeToUnix);
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return rpc.call({
              ...
              request: {
                method: 'connect',
                params: [nostrTools.getPublicKey(secretKey)]
              }
            }, {
              skipResponse: true
            });
                ...
                return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                  while (1) switch (_context5.prev = _context5.next) {
                    case 0:
                      _context5.prev = 0;
                      _context5.next = 3;
                      return nostrTools.nip04.decrypt(_this.rpc.self.secret, event.pubkey, event.content);
                    case 3:
...
exports.TimeRangeToUnix = TimeRangeToUnix;
exports.broadcastToRelay = broadcastToRelay;
