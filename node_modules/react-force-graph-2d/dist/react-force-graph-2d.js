...
(function (global, factory) {
  ...
  function index$5 (kapsuleComponent) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      nodeMapper = _ref$nodeMapper === undefined ? function (node) {
        return node;
      } : _ref$nodeMapper,
      _ref$methodNames = _ref.methodNames,
      methodNames = _ref$methodNames === undefined ? [] : _ref$methodNames,
      _ref$initPropNames = _ref.initPropNames,
      initPropNames = _ref$initPropNames === undefined ? [] : _ref$initPropNames;
      ...
      React.useImperativeHandle(ref, function () {
        return Object.fromEntries(methodNames.map(function (method) {
          return [method, function () {
            ...
            return _call.apply(undefined, [method].concat(args));
          }];
        }));
      }, [_call]);
  ...
  var _default = /*#__PURE__*/function () {
    ...
    return _createClass(_default, [{
      ...
      value: function lookup(color) {
        ...
        var n = typeof color === 'string' ? colorStr2Int(color) : rgb2Int.apply(undefined, _toConsumableArray$2(color));
