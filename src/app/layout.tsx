            ...
            <div className="container mx-auto px-4">
              <div className="flex flex-col md:flex-row justify-between items-center mb-6">
                ...
                <div className="flex items-center justify-center space-x-6 mb-4 md:mb-0">
                  <Link href="nostr:npub1dxd02kcjhgpkyrx60qnkd6j42kmc72u5lum0rp2ud8x5zfhnk4zscjj6hh" target="_blank" rel="noopener noreferrer" className="text-sand hover:text-purple-500 transition-colors" aria-label="Nostr">
                    <Image 
