...
"[project]/src/components/home/BitcoinMap.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function BitcoinMap() {
    ...
    const fetchBusinesses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            const simplifiedData = data.map((business)=>({
                    id: business.id,
                    name: business.name,
                    tags: business.tags || [],
                    lat: business.lat,
    ...
    const filteredBusinesses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!debouncedSearchQuery) return businesses;
        const query = debouncedSearchQuery.toLowerCase();
        return businesses.filter((business)=>business.name.toLowerCase().includes(query) || business.tags?.some((tag)=>tag.toLowerCase().includes(query)));
    }, [
        businesses,
...
//# sourceMappingURL=src_5371e0de._.js.map